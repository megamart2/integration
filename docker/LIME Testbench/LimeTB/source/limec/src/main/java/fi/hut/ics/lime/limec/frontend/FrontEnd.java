/**
 * Takes care of duties that make the fi.hut.ics.lime.limec tool more
...
import fi.hut.ics.lime.limec.frontend.sourceprocessor.DoxygenParser;
import fi.hut.ics.lime.limec.frontend.sourceprocessor.DoxygenStripper;
...
public class FrontEnd {
	...
	public FrontEnd(File sourceDirectory) {
		...
		try {
			...
			System.out.println("in before copying files");
			...
			System.out.println("in before stripping doxygen comments");
			stripDoxygenComments(this.tempDirectory);

			// Run Doxygen on the resulting files
			System.out.println("in before running doxygen");
	...
	/**
	 * The fi.hut.ics.lime.limec tool uses Doxygen to create a representation
	 ...
	 * classes in the fi.hut.ics.lime.limec.backend package, which also
