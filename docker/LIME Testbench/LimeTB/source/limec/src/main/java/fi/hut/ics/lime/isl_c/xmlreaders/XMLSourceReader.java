 ...
 * creating objects defined by the classes in fi.hut.ics.lime.isl_c.sourcecode. 
 * 
 ...
 * the tools in fi.hut.ics.lime.isl_c.islparser and associate the parsed ISL
...
import java.io.File;
// testing
import fi.hut.ics.lime.isl_c.Main;
...
import fi.hut.ics.lime.isl_c.xmlreaders.generators.CMethodGenerator;
