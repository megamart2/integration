...
package fi.hut.ics.lime.isl_c.staticaccessor;
...
public class StaticAccessor {
	...
	private static final String ACC_SUFFIX = "_lime_accessory_ASFD1234";
	 ...
	 */
	public static String convertToAccessorCalls(String toConvert,
												Source source) {
	 ...
	 * source file has the name "mySource.c", the modified is written as 
	 * "mySource.mc". UPDATE
	 * 
	 ...
	 */
	public static void addOriginalSourceAccessors(CSource source,
	...
	private static String addOriginalSourceAccessorsForFunctions(Source
															source) {
	...
	private static String addOriginalSourceAccessorsForVariables(Source 
															source) {
		String codeToAdd = "";
