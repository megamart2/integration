package fi.hut.ics.lime.isl_c.aspect;
...
import fi.hut.ics.lime.isl_c.aspect.generator.CodeGenerator;
...
public class ACCAspectFactory {
	...
	private void initVariables(PltlSpecification specification, Aspect aspect,
		...
		if(numberOfPtFormulas > 0) {
			...
			initializer.addCode(specification.getPre()+" = int["+numberOfPtFormulas+"];\n");
			initializer.addCode(specification.getNow()+" = int["+numberOfPtFormulas+"];\n");
		}
