...
void * __utac__cflow_t6ac_ac_0_0 (int, int, void *);


int __utac__cflow_t6ac_ac_0 ( int , int);


int __utac__cflow_t6ac_ac_0 ( int , int);


static inline void  foo1__t6mc_m__0 (int p  )  ; 

  void foo1 (int p  ) ; 
void ** foo1_utac__call__wrapper_t6mc_m_0 (struct JoinPoint * this);  
...
{
int __utac__ad__arg1 = k ; 
__utac__cflow_t6ac_ac_0_0(1, 0, (void *)(&__utac__ad__arg1) ); 
...
{ extern void * __utac__error_stack_mgt(void * env , int mode, int count)  ; 
 ...
 __utac__exception__cf_handler_set (tmp, & __utac__cflow_t6ac_ac_0, __utac__cflow_t6ac_ac_0(3,0)); } 
 } 
__utac__cflow_t6ac_ac_0 ( 1, 0 ) ; 
...
# 603 "t6mc_m.c"
  ...
  void __utac_acc__t6ac_ac__2 (int a ,int b  , struct JoinPoint * );
int __utac__cflow_t6ac_ac_0(int, int);
void * __utac__cflow_t6ac_ac_0_0 (int,int,void*);
...
this.fp = &(foo1_utac__call__wrapper_t6mc_m_0);
this.retValue = __utac__retp ; 
this.retType ="void" ; 
 { 
int __utac__ad__arg1 = p ; 
int __utac__ad__arg2 =  * (int * )__utac__cflow_t6ac_ac_0_0 ( 2 , 0, 0 ) ; 
if( __utac__cflow_t6ac_ac_0(3,0) ) { 
__utac_acc__t6ac_ac__2(__utac__ad__arg1 ,__utac__ad__arg2 ,&this );
 } 

 else { 
foo1_utac__call__wrapper_t6mc_m_0(&this ) ; 
 } 
