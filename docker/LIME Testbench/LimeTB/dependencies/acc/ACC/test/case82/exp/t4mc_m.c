...
struct A {int x; 
  ...
  void __utac_acc__t4ac_ac__1 (void);


  void __utac_acc__t4ac_ac__3 (  struct JoinPoint * );


  void foo () ; 
  void fooutac__exec__ori () ; 
void ** foo_utac__exec__wrapper_t4mc_m_0 (struct JoinPoint * this);  
...
return this->retValue; 
  ...
  void __utac_acc__t4ac_ac__2 (void);
...
this.fp = &(foo_utac__exec__wrapper_t4mc_m_0);
this.retValue = __utac__retp ; 
this.retType ="void" ; 
 { 
__utac_acc__t4ac_ac__3(&this );
