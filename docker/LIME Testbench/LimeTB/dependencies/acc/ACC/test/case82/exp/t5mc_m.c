...
int c;
  ...
  void __utac_acc__t5ac_ac__2 (  struct JoinPoint * );


  void foo () ; 
  void fooutac__exec__ori () ; 
void ** foo_utac__exec__wrapper_t5mc_m_0 (struct JoinPoint * this);  
...
this.fp = &(foo_utac__exec__wrapper_t5mc_m_0);
this.retValue = __utac__retp ; 
this.retType ="void" ; 
 { 
__utac_acc__t5ac_ac__2(&this );
