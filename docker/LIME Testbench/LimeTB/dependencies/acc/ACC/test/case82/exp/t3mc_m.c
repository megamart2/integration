...
static inline void  foo__t3mc_m__0 (void)  ; 

  void foo () ; 
void ** foo_utac__call__wrapper_t3mc_m_0 (struct JoinPoint * this);  
...
# 574 "t3mc_m.c"
  ...
  void __utac_acc__t3ac_ac__1 (void);

  void __utac_acc__t3ac_ac__2 (void);

  void __utac_acc__t3ac_ac__3 (  struct JoinPoint * );
...
this.fp = &(foo_utac__call__wrapper_t3mc_m_0);
this.retValue = __utac__retp ; 
this.retType ="void" ; 
 { 
__utac_acc__t3ac_ac__3(&this );
 
 } 
 } 

{
__utac_acc__t3ac_ac__2();
