     ...
     const char *input;
{
      ...
      do
 {
   ...
   *arg = '\0';
   argv[argc] = (__extension__ (__builtin_constant_p (copybuf) && ((size_t)(const void *)((copybuf) + 1) - (size_t)(const void *)(copybuf) == 1) ? (((__const char *) (copybuf))[0] == '\0' ? (char *) calloc (1, 1) : ({ size_t __len = strlen (copybuf) + 1; char *__retval = (char *) malloc (__len); if (__retval != ((void *)0)) __retval = (char *) memcpy (__retval, copybuf, __len); __retval; })) : __strdup (copybuf)));
   if (argv[argc] == ((void *)0))
     {
       freeargv (argv);
       argv = ((void *)0);
