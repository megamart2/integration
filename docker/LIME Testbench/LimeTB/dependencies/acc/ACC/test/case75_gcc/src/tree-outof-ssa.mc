...
enum gt_types_enum {
 ...
 gt_ggc_e_8eh_range,
 gt_ggc_e_11parser_ctxt,
 gt_ggc_e_10jdeplist_s,
 gt_ggc_e_10java_lexer,
 gt_ggc_e_12ZipDirectory,
...
extern void gt_pch_p_12hashed_entry
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_11parser_ctxt
    (void *, void *, gt_pointer_operator, void *);
...
extern void gt_pch_p_18VEC_tree_pair_s_gc
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_16named_label_list
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_20named_label_use_list
    (void *, void *, gt_pointer_operator, void *);
...
# 293 "../.././gcc/langhooks.h"
  ...
  unsigned char reduce_bit_field_operations;
...
# 417 "../.././gcc/langhooks.h"
  ...
  tree (*expr_to_decl) (tree expr, unsigned char *tc, unsigned char *ti, unsigned char *se);
...
struct diagnostic_context
{
  ...
  unsigned char issue_warnings_are_errors_message;
...
struct cgraph_local_info
{
  ...
  unsigned char externally_visible;
  ...
  unsigned char for_functions_valid;



  unsigned char vtable_method;
};
...
struct cgraph_edge * cgraph_clone_edge (struct cgraph_edge *,
            struct cgraph_node *,
            tree, gcov_type, int, unsigned char);
...
struct ipa_reference_local_vars_info_d
{
  ...
  unsigned char calls_read_all;
  unsigned char calls_write_all;
};
...
struct var_ann_d
{
  ...
  __extension__ enum mem_tag_kind mem_tag_kind : 2;
  ...
  __extension__ enum need_phi_state need_phi_state : 2;
  ...
  ipa_reference_vars_info_t reference_vars_info;
...
extern unsigned char tree_duplicate_sese_region (edge, edge, basic_block *, unsigned,
     basic_block *);
...
extern tree okay_component_ref_for_subvars (tree, unsigned long *,
         unsigned long *);
static __inline__ unsigned char var_can_have_subvars (tree);
static __inline__ unsigned char overlap_subvar (unsigned long,
       unsigned long,
       subvar_t, unsigned char *);
...
unsigned char scev_probably_wraps_p (tree, tree, tree, tree, struct loop *, unsigned char *,
       unsigned char *);
...
void create_iv (tree, tree, tree, struct loop *, block_stmt_iterator *, unsigned char,
  tree *, tree *);
...
unsigned char tree_duplicate_loop_to_header_edge (struct loop *, edge, struct loops *,
...
typedef struct VEC_fieldoff_s_base { unsigned num; unsigned alloc; fieldoff_s vec[1]; } VEC_fieldoff_s_base; typedef struct VEC_fieldoff_s_none { VEC_fieldoff_s_base base; } VEC_fieldoff_s_none; static __inline__ unsigned VEC_fieldoff_s_base_length (const VEC_fieldoff_s_base *vec_) { return vec_ ? vec_->num : 0; } static __inline__ fieldoff_s *VEC_fieldoff_s_base_last (VEC_fieldoff_s_base *vec_ ) { (void)(vec_ && vec_->num); return &vec_->vec[vec_->num - 1]; } static __inline__ fieldoff_s *VEC_fieldoff_s_base_index (VEC_fieldoff_s_base *vec_, unsigned ix_ ) { (void)(vec_ && ix_ < vec_->num); return &vec_->vec[ix_]; } static __inline__ int VEC_fieldoff_s_base_iterate (VEC_fieldoff_s_base *vec_, unsigned ix_, fieldoff_s **ptr) { if (vec_ && ix_ < vec_->num) { *ptr = &vec_->vec[ix_]; return 1; } else { *ptr = 0; return 0; } } static __inline__ size_t VEC_fieldoff_s_base_embedded_size (int alloc_) { return __builtin_offsetof (VEC_fieldoff_s_base, vec) + alloc_ * sizeof(fieldoff_s); } static __inline__ void VEC_fieldoff_s_base_embedded_init (VEC_fieldoff_s_base *vec_, int alloc_) { vec_->num = 0; vec_->alloc = alloc_; } static __inline__ int VEC_fieldoff_s_base_space (VEC_fieldoff_s_base *vec_, int alloc_ ) { (void)(alloc_ >= 0); return vec_ ? vec_->alloc - vec_->num >= (unsigned)alloc_ : !alloc_; } static __inline__ fieldoff_s *VEC_fieldoff_s_base_quick_push (VEC_fieldoff_s_base *vec_, const fieldoff_s *obj_ ) { fieldoff_s *slot_; (void)(vec_->num < vec_->alloc); slot_ = &vec_->vec[vec_->num++]; if (obj_) *slot_ = *obj_; return slot_; } static __inline__ void VEC_fieldoff_s_base_pop (VEC_fieldoff_s_base *vec_ ) { (void)(vec_->num); --vec_->num; } static __inline__ void VEC_fieldoff_s_base_truncate (VEC_fieldoff_s_base *vec_, unsigned size_ ) { (void)(vec_ ? vec_->num >= size_ : !size_); if (vec_) vec_->num = size_; } static __inline__ fieldoff_s *VEC_fieldoff_s_base_replace (VEC_fieldoff_s_base *vec_, unsigned ix_, const fieldoff_s *obj_ ) { fieldoff_s *slot_; (void)(ix_ < vec_->num); slot_ = &vec_->vec[ix_]; if (obj_) *slot_ = *obj_; return slot_; } static __inline__ fieldoff_s *VEC_fieldoff_s_base_quick_insert (VEC_fieldoff_s_base *vec_, unsigned ix_, const fieldoff_s *obj_ ) { fieldoff_s *slot_; (void)(vec_->num < vec_->alloc); (void)(ix_ <= vec_->num); slot_ = &vec_->vec[ix_]; memmove (slot_ + 1, slot_, (vec_->num++ - ix_) * sizeof (fieldoff_s)); if (obj_) *slot_ = *obj_; return slot_; } static __inline__ void VEC_fieldoff_s_base_ordered_remove (VEC_fieldoff_s_base *vec_, unsigned ix_ ) { fieldoff_s *slot_; (void)(ix_ < vec_->num); slot_ = &vec_->vec[ix_]; memmove (slot_, slot_ + 1, (--vec_->num - ix_) * sizeof (fieldoff_s)); } static __inline__ void VEC_fieldoff_s_base_unordered_remove (VEC_fieldoff_s_base *vec_, unsigned ix_ ) { (void)(ix_ < vec_->num); vec_->vec[ix_] = vec_->vec[--vec_->num]; } static __inline__ fieldoff_s *VEC_fieldoff_s_base_address (VEC_fieldoff_s_base *vec_) { return vec_ ? vec_->vec : 0; } static __inline__ unsigned VEC_fieldoff_s_base_lower_bound (VEC_fieldoff_s_base *vec_, const fieldoff_s *obj_, unsigned char (*lessthan_)(const fieldoff_s *, const fieldoff_s *) ) { unsigned int len_ = VEC_fieldoff_s_base_length (vec_); unsigned int half_, middle_; unsigned int first_ = 0; while (len_ > 0) { fieldoff_s *middle_elem_; half_ = len_ >> 1; middle_ = first_; middle_ += half_; middle_elem_ = VEC_fieldoff_s_base_index (vec_, middle_ ); if (lessthan_ (middle_elem_, obj_)) { first_ = middle_; ++first_; len_ = len_ - half_ - 1; } else len_ = half_; } return first_; } struct vec_swallow_trailing_semi;
typedef struct VEC_fieldoff_s_heap { VEC_fieldoff_s_base base; } VEC_fieldoff_s_heap; static __inline__ VEC_fieldoff_s_heap *VEC_fieldoff_s_heap_alloc (int alloc_ ) { return (VEC_fieldoff_s_heap *) vec_heap_o_reserve (((void *)0), -alloc_, __builtin_offsetof (VEC_fieldoff_s_heap, base.vec), sizeof (fieldoff_s) ); } static __inline__ VEC_fieldoff_s_heap *VEC_fieldoff_s_heap_copy (VEC_fieldoff_s_base *vec_ ) { size_t len_ = vec_ ? vec_->num : 0; VEC_fieldoff_s_heap *new_vec_ = ((void *)0); if (len_) { new_vec_ = (VEC_fieldoff_s_heap *)(vec_heap_o_reserve (((void *)0), -len_, __builtin_offsetof (VEC_fieldoff_s_heap, base.vec), sizeof (fieldoff_s) )); new_vec_->base.num = len_; memcpy (new_vec_->base.vec, vec_->vec, sizeof (fieldoff_s) * len_); } return new_vec_; } static __inline__ void VEC_fieldoff_s_heap_free (VEC_fieldoff_s_heap **vec_) { if (*vec_) free (*vec_); *vec_ = ((void *)0); } static __inline__ int VEC_fieldoff_s_heap_reserve (VEC_fieldoff_s_heap **vec_, int alloc_ ) { int extend = !VEC_fieldoff_s_base_space (((*vec_) ? &(*vec_)->base : 0), alloc_ < 0 ? -alloc_ : alloc_ ); if (extend) *vec_ = (VEC_fieldoff_s_heap *) vec_heap_o_reserve (*vec_, alloc_, __builtin_offsetof (VEC_fieldoff_s_heap, base.vec), sizeof (fieldoff_s) ); return extend; } static __inline__ void VEC_fieldoff_s_heap_safe_grow (VEC_fieldoff_s_heap **vec_, int size_ ) { (void)(size_ >= 0 && VEC_fieldoff_s_base_length ((*vec_) ? &(*vec_)->base : 0) <= (unsigned)size_); VEC_fieldoff_s_heap_reserve (vec_, (int)(*vec_ ? ((*vec_) ? &(*vec_)->base : 0)->num : 0) - size_ ); ((*vec_) ? &(*vec_)->base : 0)->num = size_; ((*vec_) ? &(*vec_)->base : 0)->num = size_; } static __inline__ fieldoff_s *VEC_fieldoff_s_heap_safe_push (VEC_fieldoff_s_heap **vec_, const fieldoff_s *obj_ ) { VEC_fieldoff_s_heap_reserve (vec_, 1 ); return VEC_fieldoff_s_base_quick_push (((*vec_) ? &(*vec_)->base : 0), obj_ ); } static __inline__ fieldoff_s *VEC_fieldoff_s_heap_safe_insert (VEC_fieldoff_s_heap **vec_, unsigned ix_, const fieldoff_s *obj_ ) { VEC_fieldoff_s_heap_reserve (vec_, 1 ); return VEC_fieldoff_s_base_quick_insert (((*vec_) ? &(*vec_)->base : 0), ix_, obj_ ); } struct vec_swallow_trailing_semi;
int push_fields_onto_fieldstack (tree, VEC_fieldoff_s_heap **,
     long, unsigned char *);
...
static __inline__ void
fill_referenced_var_vec (VEC_tree_heap **vec)
{
  referenced_var_iterator rvi;
  tree var;
  *vec = ((void *)0);
  for ((var) = first_referenced_var (&(rvi)); !end_referenced_vars_p (&(rvi)); (var) = next_referenced_var (&(rvi)))
    (VEC_tree_heap_safe_push(&(*vec),var ));
}



static __inline__ var_ann_t
var_ann (tree t)
{
...
static __inline__ enum tree_ann_type
...
static __inline__ def_operand_p
...
bsi_after_labels (basic_block bb)
{
  ...
  while (!bsi_end_p (bsi) && ((enum tree_code) (bsi_stmt (bsi))->common.code) == LABEL_EXPR)
    bsi_next (&bsi);
...
is_call_clobbered (tree var)
{
  return is_global_var (var)
    || bitmap_bit_p (call_clobbered_vars, ((var)->decl_minimal.uid));
}
...
num_ssa_operands (tree stmt, int flags)
{
  ...
  for (t = op_iter_init_tree (&(iter), stmt, flags); !op_iter_done (&(iter)); t = op_iter_next_tree (&(iter)))
    num++;
  return num;
}
...
delink_stmt_imm_use (tree stmt)
{
   ...
   if (ssa_operands_active ())
     for (use_p = op_iter_init_use (&(iter), stmt, (((0x04 | 0x08) | 0x01) | ((0x40)))); !op_iter_done (&(iter)); use_p = op_iter_next_use (&(iter)))
...
get_subvars_for_var (tree var)
{
  ...
  if (((enum tree_code) (var)->common.code) == SSA_NAME)
    subvars = *(lookup_subvars_for_var ((var)->ssa_name.var));
  else
...
static __inline__ tree
get_subvar_at (tree var, unsigned long offset)
{
  subvar_t sv;
...
var_can_have_subvars (tree v)
{
  ...
  return ((((enum tree_code) (((v)->common.type))->common.code) == ARRAY_TYPE || ((enum tree_code) (((v)->common.type))->common.code) == RECORD_TYPE || ((enum tree_code) (((v)->common.type))->common.code) == UNION_TYPE || ((enum tree_code) (((v)->common.type))->common.code) == QUAL_UNION_TYPE) &&
   ((enum tree_code) (((v)->common.type))->common.code) != ARRAY_TYPE);
}
...
static __inline__ unsigned char
overlap_subvar (unsigned long offset, unsigned long size,
  subvar_t sv, unsigned char *exact)
{
...
create_temp (tree t)
{
  ...
  else if (!((t)->decl_common.ignored_flag))
    {
...
elim_graph_add_node (elim_graph g, tree node)
{
  ...
  for (x = 0; (VEC_tree_base_iterate(((g->nodes) ? &(g->nodes)->base : 0),x,&(t))); x++)
    if (t == node)
      return;
...
elim_graph_remove_succ_edge (elim_graph g, int node)
{
  int y;
  unsigned x;
  for (x = 0; x < (VEC_int_base_length(((g->edge_list) ? &(g->edge_list)->base : 0))); x += 2)
    if ((VEC_int_base_index(((g->edge_list) ? &(g->edge_list)->base : 0),x )) == node)
      {
...
eliminate_build (elim_graph g, basic_block B)
{
 ...
 continue;
   ...
   (VEC_tree_heap_safe_push(&(g->const_copies),Ti ));
 }
      else
        {
...
elim_forward (elim_graph g, int T)
{
  ...
  do { unsigned x_; int y_; for (x_ = 0; x_ < (VEC_int_base_length((((g)->edge_list) ? &((g)->edge_list)->base : 0))); x_ += 2) { y_ = (VEC_int_base_index((((g)->edge_list) ? &((g)->edge_list)->base : 0),x_ )); if (y_ != (T)) continue; (S) = (VEC_int_base_index((((g)->edge_list) ? &((g)->edge_list)->base : 0),x_ + 1 )); { if (!((g->visited)->elms [(S) / ((unsigned) (8 * 4))] >> (S) % ((unsigned) (8 * 4)) & 1)) elim_forward (g, S); }; } } while (0);
...
{
  int P;
  do { unsigned x_; int y_; for (x_ = 0; x_ < (VEC_int_base_length((((g)->edge_list) ? &((g)->edge_list)->base : 0))); x_ += 2) { y_ = (VEC_int_base_index((((g)->edge_list) ? &((g)->edge_list)->base : 0),x_ + 1 )); if (y_ != (T)) continue; (P) = (VEC_int_base_index((((g)->edge_list) ? &((g)->edge_list)->base : 0),x_ )); { if (!((g->visited)->elms [(P) / ((unsigned) (8 * 4))] >> (P) % ((unsigned) (8 * 4)) & 1)) return 1; }; } } while (0);
...
elim_backward (elim_graph g, int T)
{
  int P;
  ((g->visited)->elms [(T) / ((unsigned) (8 * 4))] |= (unsigned long) 1 << (T) % ((unsigned) (8 * 4)));
  do { unsigned x_; int y_; for (x_ = 0; x_ < (VEC_int_base_length((((g)->edge_list) ? &((g)->edge_list)->base : 0))); x_ += 2) { y_ = (VEC_int_base_index((((g)->edge_list) ? &((g)->edge_list)->base : 0),x_ + 1 )); if (y_ != (T)) continue; (P) = (VEC_int_base_index((((g)->edge_list) ? &((g)->edge_list)->base : 0),x_ )); { if (!((g->visited)->elms [(P) / ((unsigned) (8 * 4))] >> (P) % ((unsigned) (8 * 4)) & 1)) { elim_backward (g, P); insert_copy_on_edge (g->e, partition_to_var (g->map, P), partition_to_var (g->map, T)); } }; } } while (0);
# 456 "../.././gcc/tree-outof-ssa.c"
}
  ...
  if (elim_unvisited_predecessor (g, T))
    {
      ...
      do { unsigned x_; int y_; for (x_ = 0; x_ < (VEC_int_base_length((((g)->edge_list) ? &((g)->edge_list)->base : 0))); x_ += 2) { y_ = (VEC_int_base_index((((g)->edge_list) ? &((g)->edge_list)->base : 0),x_ + 1 )); if (y_ != (T)) continue; (P) = (VEC_int_base_index((((g)->edge_list) ? &((g)->edge_list)->base : 0),x_ )); { if (!((g->visited)->elms [(P) / ((unsigned) (8 * 4))] >> (P) % ((unsigned) (8 * 4)) & 1)) { elim_backward (g, P); insert_copy_on_edge (g->e, partition_to_var (g->map, P), U); } }; } } while (0);
...
coalesce_abnormal_edges (var_map map, conflict_graph graph, root_var_p rv)
{
  ...
  for (bb = (cfun)->cfg->x_entry_block_ptr->next_bb; bb != (cfun)->cfg->x_exit_block_ptr; bb = bb->next_bb)
    for ((ei) = ei_start_1 (&((bb->succs))); ei_cond ((ei), &(e)); ei_next (&(ei)))
      if (e->dest != (cfun->cfg->x_exit_block_ptr) && e->flags & 2)
...
coalesce_phi_operands (var_map map, coalesce_list_p cl)
{
      ...
      for (phi = phi_nodes (bb); phi; phi = (((phi))->common.chain))
 {
       ...
       if (p2 != -1)
  {
    ...
    coalesce_cost ((((e)->src->frequency * (e)->probability + 10000 / 2) / 10000),
            maybe_hot_bb_p (bb),
            ((VEC_edge_base_length(((((e)->src->succs)) ? &(((e)->src->succs))->base : 0))) >= 2 && (VEC_edge_base_length(((((e)->dest->preds)) ? &(((e)->dest->preds))->base : 0))) >= 2)));
  }
     }
 }
    }
...
coalesce_result_decls (var_map map, coalesce_list_p cl)
{
      ...
      if (((enum tree_code) ((p)->ssa_name.var)->common.code) == RESULT_DECL)
 {
   if (var == (tree) ((void *)0))
     ...
     add_coalesce (cl, i, x,
     coalesce_cost ((cfun->cfg->x_exit_block_ptr)->frequency,
      maybe_hot_bb_p ((cfun->cfg->x_exit_block_ptr)),
      0));
 }
    }
}
...
coalesce_asm_operands (var_map map, coalesce_list_p cl)
{
      ...
      for (bsi = bsi_start (bb); !bsi_end_p (bsi); bsi_next (&bsi))
 {
   ...
   for (i = 0, link = (((stmt))->exp.operands[1]); link;
     ...
     outputs[i] = ((link)->list.value);

   for (link = (((stmt))->exp.operands[2]); link; link = ((link)->common.chain))
     {
       const char *constraint
  = ((const char *)((((((link)->list.purpose))->list.value))->string.str));
  ...
  continue;
       ...
       if (((enum tree_code) (outputs[match])->common.code) != SSA_NAME
    && !(tree_code_type[(int) (((enum tree_code) (outputs[match])->common.code))] == tcc_declaration))
  continue;
  ...
  continue;
       ...
       add_coalesce (cl, p1, p2, coalesce_cost (10000,
             maybe_hot_bb_p (bb),
             0));
     }
 }
...
static __inline__ value_expr_p find_value_in_list (value_expr_p, int,
            value_expr_p *);
static __inline__ void add_value_to_list (temp_expr_table_p, value_expr_p *, int);
static __inline__ void add_info_to_list (temp_expr_table_p, value_expr_p *,
         value_expr_p);
...
static __inline__ value_expr_p
  ...
  if ((call_expr = get_call_expr_in (stmt)) != (tree) ((void *)0))
    {
      ...
      if (((call_expr)->common.side_effects_flag)
   && !(call_flags & (128 | 1 | 2)))
 return 0;
    }
...
static __inline__ void
kill_expr (temp_expr_table_p tab, int partition, unsigned char clear_bit)
{
  value_expr_p ptr;
   ...
   if (tab->version_info[(def)->ssa_name.version])
     {
       ...
       for (def2 = op_iter_init_tree (&(iter2), stmt, 0x02); !op_iter_done (&(iter2)); def2 = op_iter_next_tree (&(iter2)))
  if ((def)->ssa_name.var == (def2)->ssa_name.var)
    {
      same_root_var = 1;
      break;
    }
...
dump_replaceable_exprs (FILE *f, tree *expr)
{
  ...
  for (x = 0; x < (int)((VEC_tree_base_length(((ssa_names) ? &(ssa_names)->base : 0)))) + 1; x++)
    if (expr[x])
      {
        stmt = expr[x];
      ...
      for (si = bsi_start (bb); !bsi_end_p (si); )
 {
       ...
       else
  {
   ...
   remove = 1;
     ...
     for (def_p = op_iter_init_def (&(iter), stmt, 0x02); !op_iter_done (&(iter)); def_p = op_iter_next_def (&(iter)))
       if (replace_def_variable (map, def_p, ((void *)0)))
  changed = 1;
...
typedef struct VEC_edge_heap { VEC_edge_base base; } VEC_edge_heap; static __inline__ VEC_edge_heap *VEC_edge_heap_alloc (int alloc_ ) { return (VEC_edge_heap *) vec_heap_p_reserve (((void *)0), -alloc_ ); } static __inline__ void VEC_edge_heap_free (VEC_edge_heap **vec_) { if (*vec_) free (*vec_); *vec_ = ((void *)0); } static __inline__ VEC_edge_heap *VEC_edge_heap_copy (VEC_edge_base *vec_ ) { size_t len_ = vec_ ? vec_->num : 0; VEC_edge_heap *new_vec_ = ((void *)0); if (len_) { new_vec_ = (VEC_edge_heap *)(vec_heap_p_reserve (((void *)0), -len_ )); new_vec_->base.num = len_; memcpy (new_vec_->base.vec, vec_->vec, sizeof (edge) * len_); } return new_vec_; } static __inline__ int VEC_edge_heap_reserve (VEC_edge_heap **vec_, int alloc_ ) { int extend = !VEC_edge_base_space (((*vec_) ? &(*vec_)->base : 0), alloc_ < 0 ? -alloc_ : alloc_ ); if (extend) *vec_ = (VEC_edge_heap *) vec_heap_p_reserve (*vec_, alloc_ ); return extend; } static __inline__ void VEC_edge_heap_safe_grow (VEC_edge_heap **vec_, int size_ ) { (void)(size_ >= 0 && VEC_edge_base_length ((*vec_) ? &(*vec_)->base : 0) <= (unsigned)size_); VEC_edge_heap_reserve (vec_, (int)(*vec_ ? ((*vec_) ? &(*vec_)->base : 0)->num : 0) - size_ ); ((*vec_) ? &(*vec_)->base : 0)->num = size_; } static __inline__ edge *VEC_edge_heap_safe_push (VEC_edge_heap **vec_, edge obj_ ) { VEC_edge_heap_reserve (vec_, 1 ); return VEC_edge_base_quick_push (((*vec_) ? &(*vec_)->base : 0), obj_ ); } static __inline__ edge *VEC_edge_heap_safe_insert (VEC_edge_heap **vec_, unsigned ix_, edge obj_ ) { VEC_edge_heap_reserve (vec_, 1 ); return VEC_edge_base_quick_insert (((*vec_) ? &(*vec_)->base : 0), ix_, obj_ ); } struct vec_swallow_trailing_semi;
 ...
 if (((e)->insns.t))
  ...
  for ((ei) = ei_start_1 (&((bb->preds))); ei_cond ((ei), &(e)); ei_next (&(ei)))
   ...
   if (e->flags & 1)
    ...
    if (!is_label || ((((stmt)->exp.operands[0]))->decl_common.nonlocal_flag)
        || !bsi_end_p (bsi))
      {
        bsi_commit_one_edge_insert (e, ((void *)0));
        continue;
   ...
   for (i = 0; i < (phi)->phi.num_args; i++)
     {
       ...
       if ((e->flags & 32)
    && (((enum tree_code) (arg)->common.code) != SSA_NAME
        || (!flag_tree_combine_temps
     && (arg)->ssa_name.var != result_var)))
  {
